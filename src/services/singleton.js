...
//3 ian
//1. switch butto- change between views: -1 list of cards -2 a table, where the colums are the name the experiance and ability
...
//2. on the table view instead of infinity scroll, use pagination. the total numers of pageis is the number of total items
// devided by the items per each page
